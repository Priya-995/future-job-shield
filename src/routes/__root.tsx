...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TrustHire — AI Hiring Trust Platform" },
      { property: "og:description", content: "AI-powered trust scoring detects fake jobs, ghost jobs, and hiring scams." },
